...
class CatsList extends StatefulWidget {
  ...
  CatsList(
      {@required this.id, @required this.title, @required this.description, @required this.resourceName}) {}
...
class _CatsListState extends State<CatsList> {
  ...
  Widget build(BuildContext context) {
    return Observer(
      builder: (_) => Scaffold(
        body: catApiStore.catImagesList != null ?  CustomScrollView(
        ...
        slivers: [
          SliverAppBar(
            ...
            bottom: PreferredSize(
              child: Center(
                child: widget.description != null && showDescription ? Padding(
          ...
          SliverStaggeredGrid.countBuilder(
            ...
            itemBuilder: (context, index) {
              return Image.network(catApiStore.catImagesList[index].url);
            },
